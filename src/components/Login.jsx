...
function Login({ user, fetchUser }) {
  ...
  return (
    <div className="flex min-h-screen mt-[-63px] flex-1 items-center flex-col justify-center px-6 py-12 lg:px-8">
      {user.loader ? (
        ...
        <>
          ...
          <div className="mt-10 mx-auto w-full max-w-sm">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                <button
                  className="mt-8 flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-base font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inidigo-600"
                  type="submit"
                >
                  Log in
                </button>
