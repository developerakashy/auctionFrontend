    ...
    return(
        <>
            <div className="shadow-sm backdrop-blur bg-white sticky top-0 flex justify-end sm:justify-between px-6 items-center ">
                ...
                {user.error &&
                    <div className="py-2">
                        <button
                            ...
                            className="px-4 py-2  rounded-full mr-4 font-bold hover:bg-indigo-100"
                        >
                            Log in
                        </button>
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-indigo-600 text-white font-bold rounded-full hover:bg-indigo-500"
                        >
                            Sign up
                        </button>
                    </div>
                ...
                {user.userInfo && <div className="flex items-center">
                    <button
                    ...
                    <img
                    className="ml-4 border-2 rounded-full"
                    ...
                    height={34} width={34} alt="Profile image"
                    />
                </div>}
